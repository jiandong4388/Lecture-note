...
\newcommand{\lecture}[4]{
   ...
   \framebox{
      \vbox{\vspace{2mm}
    \hbox to 6.28in { {\bf 10-725/36-725: 随机
        分析\hfill Spring 2018} }
       \vspace{4mm}
   ...
   {\bf Note}: {\it LaTeX template courtesy of CUMTB school of Science Department.}
...
\lecture{1}{April 09}{Lecturer: Jiandong Wang}{Scribes: Jiandong Wang}
...
Here is a citation, just for fun~\cite{JDW}.

\section*{References}
\beginrefs
\bibentry{JDW}{\sc Jiandong.~Wang} and {\sc S.~Donsker}, 
``Stochastic Control,''
{\it Springer},
1990, pp.~1--6.
\endrefs
